...
namespace focus
{
	public partial class Form1 : Form
	{
		...
		int rpNum = 0;//リピート回数カウント
		int sumTime = 0;//作業合計時間
		...
		private void timer1_Tick(object sender, EventArgs e)
		{
			...
			if (0 == sec)
			{
				...
				_mediaPlayer.URL = @"C:\Users\ryota.makino\source\C#\Pomodoro\music\raining.mp3";// mp3も使用可能
		...
		private void timer2_Tick(object sender, EventArgs e)
		{
			...
			if (0 == sec2)
			{
				...
				//Repeat回数＋合計時間表示
				rpNum++;
				repeatNum.Text = rpNum.ToString();
				sumTime = rpNum * (secSum + sec2Sum);
				viewtimeSum();
				System.Media.SystemSounds.Beep.Play();
				//this.Activate();
			}
		...
		//合計時間表示
		private void viewtimeSum()
		{
			sumLabel.Text = "" + sumTime / 36000 % 10 + sumTime / 3600 % 10 +
						   ":" + sumTime / 600 % 6 + sumTime / 60 % 10 +
						   ":" + sumTime / 10 % 6 + sumTime % 10;
		}
